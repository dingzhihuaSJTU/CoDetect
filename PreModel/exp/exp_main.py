...
from models import Transformer, DLinear, GRU
from utils.tools import EarlyStopping, adjust_learning_rate, visual, test_params_flop
from utils.metrics import metric
from NonStationarity import DCV
...
class Exp_Main(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        nonstationarity = DCV(inputx, 144)
        ...
        print('Non-stationarity:{}'.format(nonstationarity))
        f = open("result.txt", 'a')
        f.write(setting + "  \n")
